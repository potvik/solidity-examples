...
contract EthereumNameService is ERC721, ERC721Enumerable, Pausable, AccessControl, ERC721Burnable {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    uint256 public counter;

    constructor() ERC721("Ethereum Name Service", "ENS") {
    ...
    function increment() public onlyRole(MINTER_ROLE) {
        counter += 1;
    }

    function decrement() public onlyRole(MINTER_ROLE) {
        counter -= 1;
    }
